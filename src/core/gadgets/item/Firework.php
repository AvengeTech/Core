...
class Firework extends Item {
	...
	public static function getRandomColor(): string {
		return self::COLOR_ARRAY[array_rand(self::COLOR_ARRAY)];
	}
	...
	public function onInteractBlock(Player $player, Block $blockReplace, Block $blockClicked, int $face, Vector3 $clickVector, array &$returnedItems): ItemUseResult {
		$entity = new FireworkEntity(Location::fromObject($blockReplace->getPosition()->add(0.5, 0, 0.5), $player->getWorld(), lcg_value() * 360, 90), $this);
