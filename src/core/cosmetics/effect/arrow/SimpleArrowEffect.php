...
abstract class SimpleArrowEffect extends ArrowEffect {
	...
	public function tick(Entity $entity): void {
		$this->ticks++;
		if ($this->ticks % 2 == 0)
			$entity->getPosition()->getWorld()->addParticle($entity->getPosition(), $this->getParticle(), Cosmetics::getEffectViewers($entity->getOwningEntity(), $entity->getPosition()));
	}
}
