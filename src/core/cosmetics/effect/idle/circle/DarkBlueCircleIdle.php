...
class DarkBlueCircleIdle extends CircleIdleEffect {

	public function getId(): int {
		return CosmeticData::IDLE_DARK_BLUE_CIRCLE;
	}

	public function getName(): string {
		return "Dark Blue Circle";
	}
	...
	public function activate(Player|CosmeticModel $player): void {
		...
		$particle = new DustParticle(new Color(0, 0, 255));
