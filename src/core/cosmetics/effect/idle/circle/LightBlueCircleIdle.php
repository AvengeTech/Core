...
class LightBlueCircleIdle extends CircleIdleEffect {

	public function getId(): int {
		return CosmeticData::IDLE_LIGHT_BLUE_CIRCLE;
	}

	public function getName(): string {
		return "Light Blue Circle";
	}
	...
	public function activate(Player|CosmeticModel $player): void {
		...
		$particle = new DustParticle(new Color(207, 246, 255));
