...
class LightPurpleCircleIdle extends CircleIdleEffect {

	public function getId(): int {
		return CosmeticData::IDLE_LIGHT_PURPLE_CIRCLE;
	}

	public function getName(): string {
		return "Light Purple Circle";
	}
	...
	public function activate(Player|CosmeticModel $player): void {
		...
		$particle = new DustParticle(new Color(255, 0, 255));
