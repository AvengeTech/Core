...
use pocketmine\network\mcpe\NetworkSession as McpeNetworkSession;
...
use core\network\handler\InGamePacketHandler;
use pocketmine\network\mcpe\handler\LoginPacketHandler;
use pocketmine\network\mcpe\handler\PacketHandler;
use core\network\handler\PreSpawnPacketHandler;
use pocketmine\item\Item;
use pocketmine\network\mcpe\handler\ResourcePacksPacketHandler;
use core\network\handler\SessionStartPacketHandler;
...
class NetworkSession extends McpeNetworkSession {
	...
	private const INCOMING_GAME_PACKETS_PER_TICK = 20; // Changed from 2 => 20 to prevent high fps players getting packet errors at high fps
	private const INCOMING_GAME_PACKETS_BUFFER_TICKS = 1000; // Changed from 100 => 1000 ^^^^^
